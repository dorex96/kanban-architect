...
| Agent chat persistence | DONE | `apps/api/prisma/migrations/20260416230000_add_chat_messages/`, `apps/api/prisma/migrations/20260426123000_add_chat_message_reply_context/` |
...
`apps/api/prisma/migrations/20260426123000_add_chat_message_reply_context/migration.sql` → Migration adding ChatMessage.replyContext JSON snapshot for notification-reply history
